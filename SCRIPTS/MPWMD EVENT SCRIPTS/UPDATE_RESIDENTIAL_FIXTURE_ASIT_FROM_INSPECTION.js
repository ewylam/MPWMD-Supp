...
if ((wfTask == "Conservation" && wfStatus == "Update from Checklist") || (wfTask == "Inspection" && wfStatus == "Update from Checklist") || (wfTask == "Application Recieved" && wfStatus == "Update from Checklist")) {
	var vInspectionId;
